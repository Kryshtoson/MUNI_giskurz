### Mapa zajmoveho uzemi se znazornenimi snimky a malou mapou s polohu zajmoveho uzemi v ramci ČR
...
# Mapa zajmoveho uzemi s vyznacenim krajem a vegetacnimi snimky na podkladove mape z osm
